...
s = 115
v = int(input('Введите скорость маишны км/ч: '))
t = int(input('Введите сколько часов катался на машине: '))
distance = v * t
circle = distance // s
print(f'Вася проехал {distance} километров и сделал {circle} кургов')